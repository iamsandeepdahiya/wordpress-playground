...
export const dependenciesTotalSize = 14813275;
export function init(RuntimeName, PHPLoader) {
	...
	var _wasm_read = (Module['_wasm_read'] = (a0, a1, a2) =>
		(_wasm_read = Module['_wasm_read'] = wasmExports['ab'])(a0, a1, a2));

	var _fflush = (a0) => (_fflush = wasmExports['bb'])(a0);

	var _wasm_popen = (Module['_wasm_popen'] = (a0, a1) =>
		(_wasm_popen = Module['_wasm_popen'] = wasmExports['cb'])(a0, a1));

	var _wasm_php_exec = (Module['_wasm_php_exec'] = (a0, a1, a2, a3) =>
		(_wasm_php_exec = Module['_wasm_php_exec'] = wasmExports['db'])(
			a0,
			a1,
			a2,
			a3
	...
	var _php_pollfd_for = (Module['_php_pollfd_for'] = (a0, a1, a2) =>
		(_php_pollfd_for = Module['_php_pollfd_for'] = wasmExports['eb'])(
			a0,
			a1,
			a2
		));
	...
	var _htonl = (a0) => (_htonl = wasmExports['hb'])(a0);

	var _wasm_sleep = (Module['_wasm_sleep'] = (a0) =>
		(_wasm_sleep = Module['_wasm_sleep'] = wasmExports['ib'])(a0));
